...
<div class="main">
  ...
  <section id="content">
    <div class="container_12">
      <div class="grid_12">
        <div class="pad-3">
          <h3 class="p5">Admin Services</h3>
          <div class="block-8 wrap">
            <div> <img src="images/page4-img1.jpg" alt="" class="img-border">
              <p class="top-1"><a href="#" class="link"><strong>Search profiles</strong></a></p>
              <p>This tool is used to search information of user profiles... <a href="#" class="link">Read More</a></p>
            </div>
            <div> <img src="images/page4-img2.jpg" alt="" class="img-border">
              <p class="top-1"><a href="#" class="link"><strong>Message Center</strong></a></p>
              <p>Manage sent/received messages from customers... <a href="#" class="link">Read More</a></p>
            </div>
            <div class="last"> <img src="images/page4-img3.jpg" alt="" class="img-border">
              <p class="top-1"><a href="#" class="link"><strong>Offers</strong></a></p>
              <p>Send offers about new products, invitations... <a href="#" class="link">Read More</a></p>
            </div>
          </div>
        </div>
      </div>
