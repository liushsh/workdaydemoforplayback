...
public class RedisProfile {
	...
	public Response getProfile(@QueryParam("username") String username) throws Exception {
		...
		String endPoint = config.Configuration.getPropertyValue("customerAccountServiceEndPoint")+"/api/redisprofile";
		//String endPoint = "http://localhost:8080/customeraccountservice" + "/api/redisprofile";
