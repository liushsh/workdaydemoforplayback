...
function mongoCreateProfile()
{
	...
	xhrAttach("/mongoattach?"+queryParams, form, function(item){
		$("#register_error_div").html("Profile has been registered successfully.");
		//$('#register_form')[0].reset(); // To reset form fields
	}, function(err){
		console.log(err);
...
function redisCreateProfile()
{
	...
	xhrAttach("api/redisattach?"+queryParams, form, function(item){
		$("#register_error_div").html("Profile has been registered successfully.");
		//$('#register_form')[0].reset(); // To reset form fields
	}, function(err){
		console.log(err);
